  ...
  return <footer className="bg-foreground text-background py-20 lg:py-24">
    <div className="container mx-auto px-6 lg:px-12">
      <div className="flex flex-col gap-10 lg:gap-12">
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-sm font-normal tracking-wide">Personal Ledger</span>
          </div>
          <p className="text-background/70 text-xs font-light leading-relaxed max-w-xs">
            Empowering you to take control of your finances with smart tracking, insights, and budgeting tools.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="grid grid-cols-2 gap-x-8 gap-y-3">
            ...
            <li>
              <Link to="/dashboard" className="text-background/70 hover:text-background smooth-hover text-xs font-light">
                Dashboard
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/features" className="text-background/70 hover:text-background smooth-hover text-xs font-light">
                Features
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2 mb-8">
            <a href="mailto:support@personalledger.com" className="text-background/70 hover:text-background smooth-hover text-xs font-light flex items-center gap-2">
              <Mail className="h-3 w-3" />
              support@personalledger.com
            </a>
      ...
      <div className="border-t border-background/20 pt-8 mt-12 text-center text-background/50 text-xs font-light">
        <p>&copy; 2026 Personal Ledger Manager. All rights reserved.</p>
      </div>
    </div>
  </footer>;
};
